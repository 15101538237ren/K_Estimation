...
OFM = 1; % The order of magnitude for which K difference can be considered as conservative.
...
OUT_FIG_DIR = strcat('Figures/REPLICATE_K_CONSISTENCY_SYN_OFM_',num2str(round(OFM,1)),'/');
...
%     depth D
    ...
    for D = 5: 5: 20
        ...
        K_RANDOM_fig = strcat(READ_DEPTH_FIG_DIR, 'K_RANDOM_',num2str(D),'.pdf');
        heatmap(REP1_K_RANDOM, REP2_K_RANDOM, K_RANDOM_fig, OFM, random_label1, random_label2);
    end
end
